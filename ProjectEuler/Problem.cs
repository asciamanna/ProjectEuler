...
namespace ProjectEuler {
  public abstract class Problem {
    ...
    public void SolveToConsole() {
      ...
      Console.WriteLine("-----------");
      Console.WriteLine(string.Format("Milliseconds: {0}", (endTime - startTime).TotalSeconds));
      Console.WriteLine(string.Format("Seconds: {0}", (endTime - startTime).TotalMilliseconds));
